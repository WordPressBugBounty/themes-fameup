...
$fameup_theme_path = get_template_directory() . '/inc/ansar/';
	...
	require_once get_template_directory() . '/inc/ansar/customizer-admin/fameup-admin-plugin-install.php';
...
function fameup_widgets_init() {
	...
	register_sidebar( array(
		...
		'description'   => '',
		'before_widget' => '<div id="%1$s" class="col-md-'.$fameup_footer_column_layout.' rotateInDownLeft animated bs-widget %2$s">',
		'after_widget'  => '</div>',
		'before_title'  => '<h6>',
		'after_title'   => '</h6>',
	) );
