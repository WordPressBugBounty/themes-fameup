              ...
              <div class="bs-latest-news mb-3 two">
                <?php $fameup_brk_news_title = fameup_get_option('breaking_news_title'); ?>
                    <!-- bs-latest-news -->
                            ...
                            <div class="bn_title">
                                <h2 class="title"><i class="fas fa-bolt"></i> <?php if (!empty($fameup_brk_news_title)): ?>
                                  ...
                                  global $post;
                                    while ($all_posts->have_posts()) : $all_posts->the_post();
                                        ?>
                                         ...
                                         <?php } else {?>
                                         <img class="img" src="<?php echo esc_url(get_stylesheet_directory_uri()); ?>/images/image.jpg" alt="<?php the_title(); ?>" />
                                         <?php } }?>
