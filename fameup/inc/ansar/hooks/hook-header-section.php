          ...
          <div class="row align-items-center">
            ...
            <div class="col-md-5 col-xs-12">
              <ul class="bs-social info-right">
                <?php do_action('fameup_action_header_social_section') ?>
              </ul>
            </div>
            <!--/col-md-6-->
          </div>
...
{ 
  ...
  $fameup_header_tele_target = esc_attr(get_theme_mod('fameup_header_tele_target','true'));
  if($header_social_icon_enable == 1){ 
    if($fameup_header_fb_link !=''){ ?>
    <li>
      <a <?php if($fameup_header_fb_target) { ?> target="_blank" <?php } ?>href="<?php echo esc_url($fameup_header_fb_link); ?>">
        <i class="fab fa-facebook"></i> 
      </a>
    </li>
    <?php } if($fameup_header_twt_link !=''){ ?>
    <li>
      <a <?php if($fameup_header_twt_target) { ?>target="_blank" <?php } ?>href="<?php echo esc_url($fameup_header_twt_link);?>">
        <i class="fa-brands fa-x-twitter"></i>
      </a>
    </li>
    <?php } if($fameup_header_lnkd_link !=''){ ?>
    <li>
      <a <?php if($fameup_header_lnkd_target) { ?>target="_blank" <?php } ?> href="<?php echo esc_url($fameup_header_lnkd_link); ?>">
        <i class="fab fa-linkedin"></i>
      </a>
    </li>
    <?php } if($fameup_header_insta_link !=''){ ?>
    <li>
      <a <?php if($fameup_insta_insta_target) { ?>target="_blank" <?php } ?> href="<?php echo esc_url($fameup_header_insta_link); ?>">
        <i class="fab fa-instagram"></i>
      </a>
    </li>
    <?php } if($fameup_header_youtube_link !=''){ ?>
    <li>
      <a <?php if($fameup_header_youtube_target) { ?>target="_blank" <?php } ?> href="<?php echo esc_url($fameup_header_youtube_link); ?>">
        <i class="fab fa-youtube"></i>
      </a>
    </li>
    <?php } if($fameup_header_pintrest_link !=''){ ?>
    <li>
      <a <?php if($fameup_header_pintrest_target) { ?>target="_blank" <?php } ?> href="<?php echo esc_url($fameup_header_pintrest_link); ?>">
        <i class="fab fa-pinterest-p"></i>
      </a>
    </li>
    <?php } if($fameup_header_telegram_link !=''){ ?>
    <li>
      <a <?php if($fameup_header_tele_target) { ?>target="_blank" <?php } ?> href="<?php echo esc_url($fameup_header_telegram_link); ?>">
