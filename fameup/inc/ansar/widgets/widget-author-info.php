                ...
                <ul class="bs-social list-inline"> 
                    ...
                    <li>
                        <span class="icon-soci facebook">
                            <a <?php if($instance['open_btnone_new_window']) { ?> target="_blank" <?php } ?>href="<?php echo esc_url($instance['facebook']); ?>">
                    ...
                    <li>
                        <span class="icon-soci twitter">
                            <a <?php if($instance['open_btnone_new_window']) { ?>target="_blank" <?php } ?>href="<?php echo esc_url($instance['twt']);?>">
                    ...
                    <li>
                        <span class="icon-soci instagram">
                            <a <?php if($instance['open_btnone_new_window']) { ?>target="_blank" <?php } ?> href="<?php echo esc_url($instance['insta']); ?>">
                    ...
                    <li>
                        <span class="icon-soci youtube">
                            <a <?php if($instance['open_btnone_new_window']) { ?>target="_blank" <?php } ?> href="<?php echo esc_url($instance['youtube']); ?>">
                    ...
                    <li>
                        <span class="icon-soci linkedin">
                            <a <?php if($instance['open_btnone_new_window']) { ?>target="_blank" <?php } ?> href="<?php echo esc_url($instance['lnk']); ?>">
                    ...
                    <li>
                        <span class="icon-soci pinterest">
                            <a <?php if($instance['open_btnone_new_window']) { ?>target="_blank" <?php } ?> href="<?php echo esc_url($instance['pntr']); ?>">
