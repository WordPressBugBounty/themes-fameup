...
class featured_post_Widget extends WP_Widget {
	...
	function __construct() {
		...
		parent::__construct( 'featured_post_Widget', __( 'AR: Featured Posts List', 'fameup' ), $widget_options );
	...
	public function form( $instance ) {
		...
		$title = ! empty( $instance['title'] ) ? $instance['title'] : esc_html__( 'Featured Posts', 'fameup' );
